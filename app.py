...
AVAILABLE_MODELS = {
    ...
    "Gemini 1.5 Pro (Complex Reasoning)": "gemini-1.5-pro", "Gemini 2.0 Flash (Fast & Versatile)": "gemini-2.0-flash-lite", "Gemini 2.5 Flash (Fast & Versatile)": "gemini-2.5-flash",
    "Gemini 2.5 Pro (paid)": "gemini-2.5-pro", # Placeholder, might need actual model ID
    "Gemini 2.5 Pro Exp. Preview (Enhanced Reasoning)": "gemini-2.5-pro", # Keep using this if available
}
